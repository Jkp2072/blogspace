...
.error{
  ...
  height : 15%;
   ...
   <!-- https://cdn2.iconfinder.com/data/icons/android-12/512/logout_signout-512.png
    ...
    <form action="{{route('a.sendmail')}}" method="get">
...
<input type="hidden" name="fromname"  value="{{$info->name}}">
<input class="a" type="email" name="emails"  placeholder="Enter email.....">
<div class="error">@error('emails'){{ $message  }}@enderror</div> 
<input class="a" type="textarea" name="maildata"  placeholder="Enter data.....">
<div class="error">@error('maildata'){{ $message }}@enderror</div> 
<input class="a" type="text" name="subject"  placeholder="Enter subject.....">
<div class="error">@error('subject'){{ $message  }}@enderror</div> 
