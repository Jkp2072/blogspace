...
.ho:hover{
   ...
   <!-- https://cdn2.iconfinder.com/data/icons/android-12/512/logout_signout-512.png
    ...
    <h2 class="hel"><div class="badge bg-primary"><?php echo e($blog->title); ?></div></h2>
    </div></br>
    <div  class="card-body">

    <p class="a"><?php echo e($blog->passage); ?></p></br>
    <p class="badge bg-success text-wrap">Author: <?php echo e($blog->name); ?></p></br>
    <p class="tagg text-end fst-italic">Created on : <?php echo e($blog->created_at); ?></p></br>
    <!--<p class="tagg text-end fst-italic">Updated on : <?php echo e($blog->updated_at); ?></p></br>-->
    
    
    <form action="<?php echo e(route('a.edit')); ?>" method="post">
    ...
    <form action="<?php echo e(route('a.delete')); ?>" method="post">
    <?php echo e(csrf_field()); ?>
