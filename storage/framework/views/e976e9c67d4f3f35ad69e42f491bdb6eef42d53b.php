...
<div class="aa">
<h2 class="hh text-center">Google Mail</h2>


<input class="a" type="text" name="name"  placeholder="Enter name.....">
<div class="error"><?php if ($errors->has('name')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('name'); ?><?php echo e($message); ?><?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?></div> 
<input type="hidden" name="fromname"  value="<?php echo e($info->name); ?>">
<input class="a" type="email" name="emails"  placeholder="Enter email.....">
<div class="error"><?php if ($errors->has('emails')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('emails'); ?><?php echo e($message); ?><?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?></div> 
<input class="a" type="textarea" name="maildata"  placeholder="Enter data.....">
<div class="error"><?php if ($errors->has('maildata')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('maildata'); ?><?php echo e($message); ?><?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?></div> 
<input class="a" type="text" name="subject"  placeholder="Enter subject.....">
<div class="error"><?php if ($errors->has('subject')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('subject'); ?><?php echo e($message); ?><?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?></div> 
<input  type="hidden" name="fromemail"  value="vv11092001@gmail.com">
</br>
