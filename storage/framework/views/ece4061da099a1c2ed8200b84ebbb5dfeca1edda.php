...
.error{
  ...
  height : 15%;
   ...
   <div class="card-responsive">
    ...
    <form action="<?php echo e(route('a.sendmessage')); ?>"  method="post">
...
<div class="error"><?php if ($errors->has('mess')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('mess'); ?><?php echo e($message); ?><?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?></div> 
<input  type="hidden" name="fromname" id="fromname" value="<?php echo e($info->name); ?>">
<input type="hidden"name="fromnameid" value="<?php echo e($info->id); ?>" >
<input  type="text" class="a" name="nameid" placeholder="enter id of sender" >
<div class="error"><?php if ($errors->has('nameid')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('nameid'); ?><?php echo e($message); ?><?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?></div> 
...
</html><?php /**PATH C:\xampp\htdocs\webass5\auth\resources\views/message.blade.php ENDPATH**/ ?>